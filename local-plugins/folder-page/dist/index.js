...
var FolderContent_default = ((opts) => {
  ...
  const FolderContent = (props) => {
    ...
    const hastRoot = tree;
    const hasRealContent = hastRoot.children.length > 0;
    const content = hasRealContent ? htmlToJsx(hastRoot) : fileData?.description;
    const hideListing = options.hideListingWhenIndexed && hasRealContent;
    ...
    return /* @__PURE__ */ u2("div", { class: "popover-hint", children: [
      ...
      !hideListing && /* @__PURE__ */ u2("div", { class: "page-listing", children: [

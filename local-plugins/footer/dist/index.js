  ...
  const Footer = ({ displayClass, cfg }) => {
    ...
    return /* @__PURE__ */ u2("footer", { class: `${displayClass ?? ""}`, children: [
      /* @__PURE__ */ u2("p", { children: [
        /* @__PURE__ */ u2("a", { href: "https://theloop.community", children: "The Loop" }),
        " \xA9 ",
        year,
        " -",
        " ",
      ...
      Object.keys(links).length > 0 && /* @__PURE__ */ u2("ul", { children: Object.entries(links).map(([text, link]) => /* @__PURE__ */ u2("li", { children: /* @__PURE__ */ u2("a", { href: link, children: text }) })) })
    ] });
  };

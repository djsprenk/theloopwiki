...
var defaultOptions = {
  ...
  sortFn: (a2, b2) => {
    if (!a2.isFolder && !b2.isFolder || a2.isFolder && b2.isFolder) {
      const aOrder = a2.data?.order;
      const bOrder = b2.data?.order;
